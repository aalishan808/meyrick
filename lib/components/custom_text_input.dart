...
class CustomTextInput extends StatelessWidget {
  ...
  final bool password;
  const CustomTextInput({super.key, required this.label, required this.placeholder,
    required this.icon, required this.textEditingController, this.password=false});
